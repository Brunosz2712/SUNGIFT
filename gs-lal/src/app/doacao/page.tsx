...
export default function Doacao() {
  ...
  const validateForm = () => {
    ...
    if (!doacao.ID_MATERIAIS)
      newErrors.ID_MATERIAIS = 'O tipo de material é obrigatório.'
    if (!doacao.NR_QUANTIDADE)
      newErrors.NR_QUANTIDADE = 'A quantidade é obrigatória.'
    return newErrors
  }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-[#707070] leading-relaxed text-justify w-full max-w-[469.5px]">
              Até <strong>10 kg</strong> ganhe <strong>5%</strong> de desconto,
              de <strong>11 a 20 kg</strong> ganhe <strong>10%</strong>, de{' '}
              <strong>21 a 30 kg</strong> ganhe <strong>15%</strong> e acima de{' '}
              <strong>30 kg</strong> ganhe <strong>20%</strong>. O valor máximo
              de desconto é <strong>20%</strong>!
            </p>
          </div>
            ...
            <table className="w-full table-auto border-collapse border border-[#97987E66]">
              ...
              <tbody>
                {Array.isArray(DoacaoGet) && DoacaoGet.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={4} className="text-center text-[#505050] py-4">
