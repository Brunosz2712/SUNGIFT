...
export default function Cadastro() {
  ...
  const validateForm = () => {
    ...
    if (!Condominio.NM_CONDOMINIO)
      newErrors.NM_CONDOMINIO = 'Nome do condomínio é obrigatório.'
    ...
    if (!Condominio.DS_COMPLEMENTO)
      newErrors.DS_COMPLEMENTO = 'Complemento é obrigatório.'
